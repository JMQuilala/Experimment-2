//This program indicates the customer's total monthly bill and calculates the number of hours used by the customer in line with the subsciption package selected. 
#include <iostream>
#include <conio.h>
#include <string>
using namespace std;
...
int main() 
{
    ...
    cout<<"Package B: For P1495/mo 20 hrs of access are provided. Additional hours are P10/hr.\n";
 	...
 	cout<<"\n";
 	cout<<"What subscription package did you choose? "; cin >> package;
 		
    if ((package=="A")||(package=="a")||(package=="B")||(package=="b")||(package=="C")||(package=="c"))
    {
    	cout<<"NUMBER OF HOURS CONSUMED: ";
        cin>>time;
        if (time<=720)
        {
